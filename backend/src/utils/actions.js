export const ACTIONS = [
  ...
  { id: 't07', area: 'transport', co2Reduction: 350, label: 'Comparto coche con otras dos personas los fines de semana',                       description: 'Ejemplo: Madrid–Bilbao (700 km ida y vuelta).' },

...
const s = {
  ...
  title: { fontWeight: 900, fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', textTransform: 'uppercase', marginBottom: '2rem' },
  ...
  addInput: {
    flex: 1, border: 'none', borderBottom: '1px solid #e0e0d8',
    padding: '0.5rem 0', fontSize: '0.95rem',
    background: 'transparent', outline: 'none',
  },
  addBtn: {
    background: '#f0f7ee', color: '#2d5a27',
    border: '1.5px solid #c8e6c0', borderRadius: '8px',
  ...
  chip: {
    ...
    background: '#f0f7ee', color: '#2d5a27',
    border: '1.5px solid #c8e6c0', borderRadius: '20px',
  ...
  hint: { fontSize: '0.72rem', color: '#bbb', marginTop: '0.4rem' },
  btn: {
    width: '100%', background: '#2d5a27', color: '#fff',
